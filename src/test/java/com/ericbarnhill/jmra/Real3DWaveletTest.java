...
public class Real3DWaveletTest {
    ...
    public void testWaveletRecon() {
        ...
        ArrayMath.displaySize(niftiArray);
        ...
        MRA3D mra = new MRA3D(image, filterBank, 3);
        mra.dwt();
        ...
        ArrayMath.displaySize(mra.getFilteredData());
        //nv.data = new FourDimensionalArray(ArrayMath.convertTo4d(mra.getFilteredData()));
